...
class Friends(models.Model):
    ...
    friend_id = models.ForeignKey(
        Users, on_delete=models.CASCADE, related_name="user_friends"
    )
...
class History(models.Model):
    id = models.AutoField(primary_key=True)
    user_id = models.ForeignKey(
        Users, on_delete=models.CASCADE, related_name="user_history"
    )
    result_user = models.IntegerField()
    opponent = models.ForeignKey(
        Users, on_delete=models.CASCADE, related_name="opponent"
    )
