...
class HistoryForm(forms.ModelForm):
    ...
    def clean_type_match(self):
        ...
        if type_match not in ["tournament_quarter", "tournament_semi", "tournament_final", "match"]:
    ...
    def clean(self):
        ...
        if type_match != "match":
            ...
            if tournament_id is None or not Tournaments.objects.filter(id=tournament_id.id).exists():
